...
public class Chapter3Textbook extends JPanel 
{
    ...
    public Chapter3Textbook() 
    {
        ...
        // page 1 text
        lblTextPage1 = new JLabel("<html>A loop is a programming construct that allows you to execute a block of code repeatedly. "
                + "It iterates over a sequence of instructions until a specific condition is met. "
                + "Loops are used to automate repetitive tasks and make your code more efficient and concise."
                + "This will save code as you do not have to copy and paste </html>");

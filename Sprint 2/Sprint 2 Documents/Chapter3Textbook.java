...
public class Chapter3Textbook extends JPanel 
{
    ...
    private JButton btnHelp;					// help button for the textboox section
    ...
    public Chapter3Textbook() 
    {
        ...
        lblTextPage3 = new JLabel("<html>\r\n"
        		...
        		+ "It is important to update the variable you are using in the condition or an infinite loop will occur. Using the \"break\" term could also be used to terminate the loop as well.</p>\r\n"
        		...
        		+ "</html>\r\n"
        		+ "");
        lblTextPage3.setFont(new Font("Comic Sans MS", Font.PLAIN, 14));
